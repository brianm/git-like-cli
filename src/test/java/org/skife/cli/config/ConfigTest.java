...
public class ConfigTest
{
    ...
    {
        File first = new File("src/test/resources/org/skife/cli/config/first.properties");
        Cli<Callable> cli = Cli.<Callable>buildCli("thing", Callable.class).withCommand(Thing.class)
    ...
    {
        File first = new File("src/test/resources/org/skife/cli/config/first.properties");
        File second = new File("src/test/resources/org/skife/cli/config/second.properties");
        Cli<Callable> cli = Cli.<Callable>buildCli("thing", Callable.class).withCommand(Thing.class)
    ...
    {
        File zeroth = new File("src/test/resources/org/skife/cli/config/zeroth.properties");
        File first = new File("src/test/resources/org/skife/cli/config/first.properties");
        File second = new File("src/test/resources/org/skife/cli/config/second.properties");
        Cli<Callable> cli = Cli.<Callable>buildCli("thing", Callable.class).withCommand(Thing.class)
